...
class BleStatusRequest extends $pb.GeneratedMessage {
  factory BleStatusRequest({
    ...
    if (showIosPowerAlert != null) {
      $result.showIosPowerAlert = showIosPowerAlert;
    }
    return $result;
  }
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'BleStatusRequest', createEmptyInstance: create)
    ..aOB(1, _omitFieldNames ? '' : 'showIosPowerAlert', protoName: 'showIosPowerAlert')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  BleStatusRequest copyWith(void Function(BleStatusRequest) updates) => super.copyWith((message) => updates(message as BleStatusRequest)) as BleStatusRequest;
