...
class BleStatusRequest extends $pb.GeneratedMessage {
  factory BleStatusRequest({
    ...
    final result = create();
    if (showIosPowerAlert != null) result.showIosPowerAlert = showIosPowerAlert;
    return result;
  }

  BleStatusRequest._();

  factory BleStatusRequest.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory BleStatusRequest.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'BleStatusRequest',
      createEmptyInstance: create)
    ..aOB(1, _omitFieldNames ? '' : 'showIosPowerAlert',
        protoName: 'showIosPowerAlert')
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  BleStatusRequest clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  BleStatusRequest copyWith(void Function(BleStatusRequest) updates) =>
      super.copyWith((message) => updates(message as BleStatusRequest))
          as BleStatusRequest;
  ...
  @$core.pragma('dart2js:noInline')
  static BleStatusRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<BleStatusRequest>(create);
  static BleStatusRequest? _defaultInstance;

  @$pb.TagNumber(1)
  $core.bool get showIosPowerAlert => $_getBF(0);
  @$pb.TagNumber(1)
  set showIosPowerAlert($core.bool value) => $_setBool(0, value);
  @$pb.TagNumber(1)
  $core.bool hasShowIosPowerAlert() => $_has(0);
  @$pb.TagNumber(1)
  void clearShowIosPowerAlert() => $_clearField(1);
}
...
class DeviceInfo extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<GenericFailure>(3, _omitFieldNames ? '' : 'failure',
        subBuilder: GenericFailure.create)
    ..aOS(4, _omitFieldNames ? '' : 'failureReason', protoName: 'failureReason')
    ..hasRequiredFields = false;
