...
const BleStatusRequest$json = {
  '1': 'BleStatusRequest',
  '2': [
    {'1': 'showIosPowerAlert', '3': 1, '4': 1, '5': 8, '10': 'showIosPowerAlert'},
  ],
};

/// Descriptor for `BleStatusRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List bleStatusRequestDescriptor = $convert.base64Decode(
    'ChBCbGVTdGF0dXNSZXF1ZXN0EiwKEXNob3dJb3NQb3dlckFsZXJ0GAEgASgIUhFzaG93SW9zUG'
    '93ZXJBbGVydA==');
...
const DeviceInfo$json = {
  ...
  '2': [
    ...
    {'1': 'failure', '3': 3, '4': 1, '5': 11, '6': '.GenericFailure', '10': 'failure'},
    {'1': 'failureReason', '3': 4, '4': 1, '5': 9, '10': 'failureReason'},
  ],
};
...
final $typed_data.Uint8List deviceInfoDescriptor = $convert.base64Decode(
    ...
    'cmUSJAoNZmFpbHVyZVJlYXNvbhgEIAEoCVINZmFpbHVyZVJlYXNvbg==');
